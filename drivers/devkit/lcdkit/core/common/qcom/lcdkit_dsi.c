...
static void lcdkit_regulator_init(struct dss_vreg *vreg, int cnt)
{
    ...
    for (i = 0; i < cnt; i++)
    {
        if (0 == strncmp(vreg[i].vreg_name,
            LCDKIT_VREG_VDD_NAME, strlen(LCDKIT_VREG_VDD_NAME)))
        {
            ...
            LCDKIT_VREG_VDDIO_NAME, strlen(LCDKIT_VREG_VDDIO_NAME)))
        {
            ...
            LCDKIT_VREG_BIAS_NAME, strlen(LCDKIT_VREG_BIAS_NAME)))
        {
        ...
        //may be something wrong here! IBB == VSP?
        else if (0 == strncmp(vreg[i].vreg_name,
            LCDKIT_VREG_IBB_NAME, strlen(LCDKIT_VREG_IBB_NAME)))
        {
            ...
            LCDKIT_VREG_LAB_NAME, strlen(LCDKIT_VREG_LAB_NAME)))
        {
